...
public class WebSocketProxyHandler extends BinaryWebSocketHandler {
    ...
    private final TokenAuthenticationService tokenAuthService; // Add token service
    ...
    public WebSocketProxyHandler(DeviceSessionManager deviceSessionManager, TokenAuthenticationService tokenAuthService) {
...
//        if (deviceId != null) {
            ...
            if (token != null && tokenAuthService.validateToken(deviceId, token)) {
